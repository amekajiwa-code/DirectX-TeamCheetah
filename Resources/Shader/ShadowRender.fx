...
ShadowOutput VS_Mesh(VertexMesh input)
{
	MeshOutput output;
...
ShadowOutput VS_Model(VertexModel input)
{
	MeshOutput output;
...
ShadowOutput VS_Animation(VertexModel input)
{
	MeshOutput output;
...
technique11 T0
{
	PASS_RS_SP(P0, VS_Mesh)
	PASS_RS_SP(P1, VS_Model)
	PASS_RS_SP(P2, VS_Animation)
};
