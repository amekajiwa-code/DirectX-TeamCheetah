...
void ImGuiManager::Update()
{
    ...
    if (show_nickname_window)
    {
        //float windowSizeX = 300.0f;
        //float windowSizeY = 50.0f;
        //// Set the window size to a fixed value
        //ImGui::SetNextWindowSize(ImVec2(windowSizeX, windowSizeY), ImGuiCond_Always);
        //ImVec2 displaySize = ImGui::GetIO().DisplaySize;
        //ImGui::SetNextWindowPos(ImVec2(displaySize.x / 2 - windowSizeX / 2, displaySize.y / 2 - windowSizeY / 2), ImGuiCond_Always);
        ...
        //float b = 25.0f / 255.0f;
        //ImGui::PushStyleColor(ImGuiCol_WindowBg, ImVec4(r, g, b, 0.9f));
        //ImGui::Begin("NickWindow", &show_nickname_window, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize);
        //
        //wchar_t tempBuffer[256] = L"닉네임";
        //int bufferSize = WideCharToMultiByte(CP_UTF8, 0, tempBuffer, -1, nullptr, 0, nullptr, nullptr);
        //char* charBuffer = new char[bufferSize];
        //WideCharToMultiByte(CP_UTF8, 0, tempBuffer, -1, charBuffer, bufferSize, nullptr, nullptr);
        //ImGui::Text(charBuffer);
        //delete[] charBuffer;
        //ImGui::PopStyleColor();
        //ImGui::SameLine();
        ...
        //// 채팅 입력박스
        //ImGui::PushStyleColor(ImGuiCol_FrameBg, ImVec4(0.3f, 0.3f, 0.3f, 0.5f));
        //if (ImGui::InputText("##NameInput", nameBuffer, sizeof(nameBuffer), ImGuiInputTextFlags_EnterReturnsTrue))
        //{
        //    show_nickname_window = false;
        //}
        //ImGui::PopStyleColor(1);
        ...
        //ImVec4 buttonColor(r, g, b, 0.5f);
        //ImGui::PushStyleColor(ImGuiCol_Button, buttonColor);
        //if (ImGui::Button("OK") && nameBuffer[0] != '\0') // 버튼을 클릭하면 메시지를 보냄 (비어있지 않은 경우)
        //{
        //    show_nickname_window = false;
        //}
