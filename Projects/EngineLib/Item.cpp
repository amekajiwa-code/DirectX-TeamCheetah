...
bool Item::LoadItemInformationFromFile(const wstring& loadPath)
{
    //Set LoadPath
...
bool Item::SaveItemInformationToFile(const wstring& savePath)
{
    //Set SavePath
...
bool Item::ItemEffectToSelf()
{
    return false;
}

bool Item::ItemEffectToTarget(const shared_ptr<GameObject>& target)
{
    return false;
}
